...
const whatIsYourName = () => {
    axios.get('http://localhost:3000/query-test/?name=jason')
    .then(res => {
        console.log(res.data)
    })
    .catch(error => {
...
queryBtn.addEventListener('click', whatIsYourName);

// axios.get('http://localhost:3000/query-test/?who-is-the-boss')
// .then(({ data }) => console.log(data));    /* this answer produces desired result minus event listener, not sure of syntax to make that work */
